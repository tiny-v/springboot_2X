...
public class DirectProducer {
    ...
    public static final Logger logger = LoggerFactory.getLogger(DirectProducer.class);
    ...
    public void sendToDirectExchange(String messageInfo, String bindingKey){
        ...
        rabbitTemplate.convertAndSend(DirectRabbitElement.Exchange_Direct, bindingKey, message);
    }
